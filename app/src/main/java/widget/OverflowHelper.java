...
import com.jd.wly.intercom.util.DensityUtil;

import view.PopupMenuListView;
...
public class OverflowHelper {
    ...
    public void showAsDropDown(View anchor) {
        if(mPopupWindow!=null&&anchor!=null) {
            mPopupWindow.showAsDropDown(anchor, DensityUtil.dip2px(0.0F), DensityUtil.dip2px(-24.0F));
        }
    }
